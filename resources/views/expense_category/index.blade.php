...
<div class="card mt-4">
    ...
    <div class="card-header">
        ...
        <a href="{{ route('expense_category.create') }}" class="btn btn-outline-primary mx-5">{{ __('home.new_category') }}</a>
    </div>
                                    ...
                                    <table id="data-table1" class="table table-bordered table-striped text-nowrap mb-0 table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn text-primary btn-sm" href="{{route('expense_category.edit', $category)}}" data-bs-toggle="tooltip" data-bs-original-title="Edit"><span class="fe fe-edit fs-14"></span></a>
                                                    <form action="{{route('expense_category.destroy', $category->id)}}" method="POST" class="d-inline">
                                                        @method('delete')
                                                        @csrf
                                    ...
                                    <table id="data-table1" class="table table-bordered table-striped text-nowrap mb-0 table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <form action="{{route('category.restore', $category)}}" method="POST" class="d-inline">
                                                        @method('POST')
                                                        @csrf
                                                    ...
                                                    <form action="{{route('category.forceDelete', $category)}}" method="POST" class="">
                                                        @method('delete')
                                                        @csrf
