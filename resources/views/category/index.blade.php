...
<div class="card mt-4">
    ...
    <div class="card-header">
        ...
        <a href="{{ route('category.create') }}" class="btn btn-outline-primary mx-5">{{ __('home.new_category') }}</a>
    </div>
                                    ...
                                    <table id="file-datatable" class="table table-bordered table-striped text-nowrap mb-0 table-hover">
                                        ...
                                        @php $c = 1;  @endphp
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn text-primary btn-sm" href="{{route('category.edit', $category)}}" data-bs-toggle="tooltip" data-bs-original-title="Edit"><span class="fe fe-edit fs-14"></span></a>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <form action="{{route('category.forceDelete', $category)}}" method="POST" class="d-none">
                                                        @method('delete')
                                                        @csrf
