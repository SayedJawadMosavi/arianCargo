...
<div class="card mt-4">
    ...
    <div class="card-header d-flex justify-content-between">
        <h3 class="card-title">{{ __('home.clients') }}</h3>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="btn text-success btn-sm" href="{{route('client.detail.get', $obj)}}" data-bs-toggle="tooltip" data-bs-original-title="{{ __('home.sell') }}"><span class="fe fe-eye fs-16"></span></a>
                                                        ...
                                                        <form action="{{route('client.destroy', $obj)}}" method="POST" class="d-none">
                                                            @method('delete')
                                                            @csrf
                                            ...
                                            <tr class="border-bottom">
                                                ...
                                                <td>
                                                    <div class="g-2 ">
                                                        ...
                                                        <form action="{{route('client.restore', $obj)}}" method="POST" class="d-inline">
                                                            @method('POST')
                                                            @csrf
                                                        ...
                                                        <form action="{{route('client.forceDelete', $obj)}}" method="POST" class="d-inline">
                                                            @method('delete')
                                                            @csrf
