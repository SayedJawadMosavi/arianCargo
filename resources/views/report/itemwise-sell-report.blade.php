@extends('layouts.app')
@section('title', 'Item Wise Sell Report')
                        ...
                        @forelse($sell as $obj)
                            ...
                            <tr>
                                ...
                                @else
                                    ...
                                    @endif
                                <td>{{$obj->sell->id}}</td>
                                <td>{{$obj->sell->client->name}} </td>
                                <td>{{$obj->product->name}} - {{$obj->product->model}}</td>
                                <td>{{number_format($obj->cost, 2)}} ({{ $obj->sell->currency->name }})</td>
                                <td>{{$obj->quantity}}</td>
                                <td>{{number_format($total = $obj->cost * $obj->quantity) }} ({{ $obj->sell->currency->name }})</td>
